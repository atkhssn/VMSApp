    ...
    public class VehicleService
    {
        ...
        public bool Create(VehicleModel model)
        {
            ...
            try
            {
                ...
                Vehicle vehicle = new Vehicle()
                {
                    ...
                    IsStanderd = model.vehicleType == 0 ? false : true,
                    ...
                    RegExpiryDate = model.Reg_Expired,
                    ChassisNo = model.Chassis,
                    EngineNo = model.Engine,
                    TaxToeknFitness = model.fitness_TaxToken,
        ...
        public object SearchEdit(long id)
        {
...

            {
                ...
                vehicleTypeId = Vehicle.IsStanderd==false?0:1,
                vehicleTypeName = Vehicle.IsStanderd==false? "Hybrid" : "Standard",
                ...
                fitnessToken= Vehicle.TaxToeknFitness,
        ...
        public bool Edit(VehicleModel model)
        {
            ...
            try
            {
                ...
                vehicleObject.RegExpiryDate = model.Reg_Expired;
                vehicleObject.TaxToeknFitness = model.fitness_TaxToken;
